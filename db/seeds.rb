...
user = User.first
opl = eastbay.locations.create(name: "Oakland Public Library - Main", notes: nil, lat: 0.37800978e2, lng: -0.122265797e3, zoom: 17, street: nil, city: nil, state: nil, user: user)
